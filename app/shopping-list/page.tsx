        ...
        <Table.Tr key={item.name}>
            ...
            <Table.Td>
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 3C9 3.27614 9.22386 3.5 9.5 3.5C9.77614 3.5 10 3.27614 10 3C10 2.72386 9.77614 2.5 9.5 2.5C9.22386 2.5 9 2.72386 9 3Z" fill="black" stroke="black" strokeWidth="0.75" stroke-miterlimit="10"/>
                    <path d="M9 10C9 10.2761 9.22386 10.5 9.5 10.5C9.77614 10.5 10 10.2761 10 10C10 9.72386 9.77614 9.5 9.5 9.5C9.22386 9.5 9 9.72386 9 10Z" fill="black" stroke="black" strokeWidth="0.75" stroke-miterlimit="10"/>
                    <path d="M9 17C9 17.2761 9.22386 17.5 9.5 17.5C9.77614 17.5 10 17.2761 10 17C10 16.7239 9.77614 16.5 9.5 16.5C9.22386 16.5 9 16.7239 9 17Z" fill="black" stroke="black" strokeWidth="0.75" stroke-miterlimit="10"/>
                </svg>
                </button>
